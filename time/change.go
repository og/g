...
func EndOfSecond (v time.Time) time.Time {
	return time.Date(v.Year(), v.Month(), v.Day(), v.Hour(), v.Minute() ,59, maxNSecs, v.Location())
}
...
func EndOfMinute (v time.Time) time.Time {
	return time.Date(v.Year(), v.Month(), v.Day(), v.Hour(), 59 ,59, maxNSecs, v.Location())
}
...
func EndOfHour (v time.Time) time.Time {
	return time.Date(v.Year(), v.Month(), v.Day(), 23, 59 ,59, maxNSecs, v.Location())
}
...
func EndOfDay(v time.Time) time.Time {
	return time.Date(v.Year(), v.Month()+1, 1, 23, 59 ,59, maxNSecs, v.Location()).AddDate(0,0,-1)
}
...
func EndOfMonth(v time.Time) time.Time {
	return time.Date(v.Year(), time.December, 31, 23, 59 ,59, maxNSecs, v.Location())
}
